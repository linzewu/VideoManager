...
<script type="text/javascript" src="/VideoManager/js/data.js"></script>
<script src="/VideoManager/codebase/webVideoCtrl.js"></script>
	...
	$(function () {
		...
		if (-2 == iRet) {
	        ...
	        $.messager.alert("提示","您还未安装过插件，请安装WebComponentsKit.exe！","info",function(){
				window.open("/VideoManager/codebase/WebComponentsKit.exe")
			});
			return;
	    }
